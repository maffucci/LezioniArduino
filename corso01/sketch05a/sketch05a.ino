/*  
  ...
  funzionalità:
   ...
   - accensione e spegnimento contemporaneo dei due LED.
...
void loop() {
  ...
  digitalWrite(LED02, HIGH);   // accende il LED01 (livello di tensione HIGH)
  delay(1000);                 // attesa di 1 secondo
  digitalWrite(LED01, LOW);    // spegne il LED01 (livello di tensione LOW)
  digitalWrite(LED02, LOW);    // spegne il LED01 (livello di tensione LOW)
  delay(1000);                 // attesa di 1 secondo
}
